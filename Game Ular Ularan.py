# -*- coding: utf-8 -*-
"""
Created on Wed Nov 25 15:08:20 2020
...
class Snake(Frame):
    ...
    def __init__(self):
        ...
        self.master.title("game ulo-ulonan.wahyu")
        self.grid()
        ...
        newGame = Button(frame1, text = "Tarik Sis", command = self.new_game)
    ...
    def new_game(self):
        ...
        self.canvas.create_text(WIDTH/2,HEIGHT/2-50,text="selamat datang di game ulo-ulonan.exe ini!"\
                                + "\nklik atau tekan salah satu tombol arah"
                                + "\..", tag="welcome_text")
    ...
    def end_game(self):
        self.game_over = True
        self.canvas.create_text(WIDTH/2,HEIGHT/2,text="DASAR GOB***!!")
